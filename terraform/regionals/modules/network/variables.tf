...
variable "rwu_ipsec_vpg" {
  type        = string
  description = "The ID of the RWU AWS virtual private gateway"
}
...
variable "team_public_cidr_block" {
  type        = string
  description = "The secondary cidr range (team public)"
}
